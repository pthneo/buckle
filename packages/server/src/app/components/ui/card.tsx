...
function Card({
  ...
  return (
    <div
      className={cn(
        "group/card flex flex-col gap-6 overflow-hidden rounded-md bg-card py-6 text-card-foreground text-sm shadow-xs ring-1 ring-foreground/10 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-md *:[img:last-child]:rounded-b-md",
        className
      )}
      data-size={size}
      data-slot="card"
